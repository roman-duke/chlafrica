...
export default function Services() {
  return (
    <div className="py-10 backdrop-blur-sm">
      <div className="flex flex-col items-center">
        <h2 className="text-4xl font-bold text-brand-accent">Promoting Development through</h2>
        <span className="text-brand-earth_yellow text-4xl font-bold">Community Support</span>
      </div>

      <div className="flex items-center mt-12 gap-4 *:border-r">
        <ServiceCard 
