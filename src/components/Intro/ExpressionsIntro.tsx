...
import { expression_path_I, expression_path_II } from "@components/SectionDemarcation/paths";
import { useFlubber } from "@components/SectionDemarcation/useFlubber";

const layer_path_one = [expression_path_I, expression_path_II, expression_path_I];
...
export default function ExpressionsIntro() {
  ...
  return (
    ...
    <>
      <div className="w-[400px] h-[400px] absolute lg:-top-7">
        <svg viewBox="0 0 900 600">
          <motion.path
            d={flubber_expressions_layer} 
            fill="#c0b9e0" 
          />
        </svg>
      </div>
      ...
      >
        {/* <div className="sticky top-0 flex flex-col items-center pt-10"> */}
