...
const layer_path_three = [
  layer_three_path,
  layer_three_path_II,
  layer_three_path,
];
const layer_path_four = [layer_four_path, layer_four_path_II, layer_four_path];
const bottom_layer_path_one = [
  bottom_layer_one_path,
  bottom_layer_one_path_II,
  bottom_layer_one_path,
];
const bottom_layer_path_two = [
  bottom_layer_two_path,
  bottom_layer_two_path_II,
  bottom_layer_two_path,
];

export default function SectionDemarcation({
  type,
  customStyle,
}: SectionDemarcationProps) {
  ...
  const flubber_bottom_layer_path_one = useFlubber(
    progress,
    bottom_layer_path_one
  );
  const flubber_bottom_layer_path_two = useFlubber(
    progress,
    bottom_layer_path_two
  );
  ...
  if (type == "semi-mini") {
    return (
      <div className={`absolute w-full -bottom-1 ${customStyle}`}>
        <svg viewBox="0 0 900 200">
          <motion.path d={flubber_layer_path_three} fill="#bdb4d8" />
          <motion.path d={flubber_layer_path_four} fill="#fdfdfd" />
        </svg>
      </div>
    );
  } else if (type !== "mini") {
    return (
      <div className={`absolute w-full -bottom-1 ${customStyle}`}>
        <svg viewBox="0 0 900 200">
          <motion.path d={flubber_layer_path_one} fill="#201d7b66" />

          <motion.path d={flubber_layer_path_two} fill="#7b6db2" />
  ...
  return (
    <div className="absolute -left-1 w-[110%]">
      <svg viewBox="0 0 900 200">
        <motion.path d={flubber_bottom_layer_path_one} fill="#c1b7e880" />

        <motion.path d={flubber_bottom_layer_path_two} fill="#d6ceefC2" />
      </svg>
    </div>
  );
}
